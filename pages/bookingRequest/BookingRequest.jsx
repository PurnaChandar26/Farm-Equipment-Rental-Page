...
//     }, []);
    ...
    //         };
    //         const {data} =  await axios.get(`https://Farmers-Delight-app.herokuapp.com/api/booking/detail/${params.id}` , { headers });
    //         console.log(data);
    //         setOutput(data);
    //     }
    //     getDt();
    ...
    const handleAccept = async (id, status) => {
        ...
        await axios.patch(`https://Farmers-Delight-app.herokuapp.com/api/booking/update/${id}/` , { status }, { headers });
