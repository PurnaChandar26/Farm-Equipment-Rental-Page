...
const Help = () => {
    const booking_help = [{
            heading: "Q: How do I book an equipment on FARMERS DELIGHT",
            content: "A: You can search and book any equipment available in your location.",
        },
        {
            heading: "Q: What happens if I return the equipment late?",
            content: "A: A penalty will be applicable for th amount of time you are late.",
        },
        {
            heading: "Q: How do I end my booking?",
            content: "A: you can end your booking by visiting the Booking History page",
        },
    ];
    const renting_help = [{
        ...
        },
        {
            ...
            content: "A: You can refund your payments or amount by logging to your stripe account affiliated to farmease.",
        },
        {
            heading: "Q: What types of equipment can I list for booking?",
            content: "A: You can post all types of farming eqipment on FARMERS DELIGHT. For Example, Trucks, Tractors, etc.",
        },
    ];
