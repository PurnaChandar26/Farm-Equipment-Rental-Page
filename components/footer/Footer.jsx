      ...
      <div className="flex justify-center items-center">
          ...
          >
            ...
            <div className="ml-4">
              ...
              <p className="text-md font-normal text-white mt-2">
                Empowering Farmers, One Rental at a Time
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 px-16 border-r-2 border-black-600">
          ...
          <p className="text-lg ml-6 text-white">
            Made by : <strong>Team Farmers Delight</strong>
          </p>
        </div>
        <div className="flex-1 flex mr-6">
          <img src="https://img.collegepravesh.com/2015/12/Vellore-Institute-of-Technology-Logo.png" className="footerBgImg" alt="" />
